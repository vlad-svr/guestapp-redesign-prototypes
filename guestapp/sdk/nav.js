...
(function () {
  ...
  var css = [
    ...
    '.proto-nav summary{list-style:none;cursor:pointer;display:inline-flex;align-items:center;gap:8px;height:42px;padding:0 17px;border-radius:99px;background:#2a2a44;border:1px solid rgba(255,255,255,0.12);color:#fff;font-size:12.5px;font-weight:600;box-shadow:0 10px 26px rgba(51,51,79,0.35);user-select:none}',
    '.proto-nav summary::-webkit-details-marker{display:none}',
    '.proto-nav summary:hover{background:#33334f}',
    '.proto-nav summary .pn-dot{width:8px;height:8px;border-radius:50%;background:#9db8a9}',
    ...
    '.proto-nav a{display:flex;align-items:center;gap:10px;padding:9px 10px;border-radius:8px;font-size:12.5px;font-weight:600;color:#33334f;text-decoration:none}',
    '.proto-nav a:hover{background:#f2f3f7}',
    '.proto-nav a.active{background:#eef0f6;color:#505077;box-shadow:inset 0 0 0 1px rgba(80,80,119,0.3)}',
    ...
    '.proto-nav a .pn-badge{flex-shrink:0;margin-left:6px;font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#505077;background:#eef0f6;border-radius:99px;padding:2px 7px}',
    ...
    '.pn-flyout a.pn-sub:hover{color:#505077;background:#f2f3f7}',
    '.pn-flyout a.pn-sub .pn-dot2{width:5px;height:5px;border-radius:50%;background:#cecede;flex-shrink:0}',
    '.pn-flyout a.pn-sub:hover .pn-dot2{background:#505077}',
    ...
    '.proto-nav .pn-note a{display:inline;padding:0;color:#505077;font-weight:700}',
  ...
  menu += '<div class="pn-note">Guest <b>SDK</b> prototype (neutral) — the same flows in <a href="../sdk-guestapp/index.html">guestapp style</a>; the guestapp redesign prototype lives <a href="../index.html">one folder up</a>.</div>';

  var nav = document.createElement('details');
  nav.className = 'proto-nav';
  nav.innerHTML = '<summary><span class="pn-dot"></span> SDK prototypes</summary><div class="pn-menu">' + menu + '</div>';
