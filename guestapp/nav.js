  ...
  var PAGES = [
    ...
    { group: 'Payments', items: [
      { file: 'flow-payments-mobile.html', label: 'Payments flow — mobile', icon: '📱', subs: [
        ...
        { hash: 'p-removing', label: 'Remove an item (success / failure)' },
        { hash: 'p-petfee', label: "Pet fee — the removal the app refuses" },
        { hash: 'p-form', label: 'Card form' },
        { hash: 'p-form-addon', label: 'Card form · Addon (Global Payments)' },
      ...
      { file: 'flow-payments-desktop.html', label: 'Payments flow — desktop', icon: '🖥', subs: [
        ...
        { hash: 'pd-later', label: 'Pay later' },
        { hash: 'pd-removing', label: 'Remove an item (success / failure)' },
        { hash: 'pd-petfee', label: "Pet fee — the removal the app refuses" },
        { hash: 'pd-form', label: 'Card form' },
        { hash: 'pd-form-addon', label: 'Card form · Addon (Global Payments)' },
    ...
    { group: 'AI Travel Guide', items: [
      { file: 'flow-travel-guide-v3.html', label: 'AI Travel Guide V3 — mobile', icon: '📱', subs: [
        { hash: 't3-intro', label: 'Intro' },
        { hash: 't3-q1', label: 'Q1 · Pace' },
        { hash: 't3-q2', label: 'Q2 · Interests' },
        { hash: 't3-q3', label: 'Q3 · Budget' },
        { hash: 't3-q4', label: 'Q4 · Avoid' },
        { hash: 't3-build', label: 'Building' },
        { hash: 't3-error', label: 'Build failed' },
        { hash: 't3-plan', label: 'The plan' },
      ]},
      { file: 'flow-travel-guide-desktop-v3.html', label: 'AI Travel Guide V3 — desktop', icon: '🖥', subs: [
        { hash: 't3d-intro', label: 'Intro' },
        { hash: 't3d-q', label: 'The four questions' },
        { hash: 't3d-build', label: 'Building' },
        { hash: 't3d-error', label: 'Build failed' },
        { hash: 't3d-plan', label: 'The plan + trip rail' },
      ]},
      { file: 'flow-travel-guide-v2.html', label: 'AI Travel Guide V2 — mobile (previous)', icon: '📱', subs: [
      ...
      { file: 'flow-travel-guide-desktop-v2.html', label: 'AI Travel Guide V2 — desktop (previous)', icon: '🖥', subs: [
    ...
    { group: 'Check-out', items: [
      { file: 'flow-checkout-mobile.html', label: 'Check-out — mobile', icon: '📱', by: 'opus', subs: [
        { hash: 'co-leave', label: 'Before you leave (balance due)' },
        { hash: 'co-zero', label: 'Nothing to pay' },
        { hash: 'co-rate', label: 'Rate your stay' },
        { hash: 'co-thanks', label: 'Thanks — public reviews' },
        { hash: 'co-thanks-quiet', label: 'Thanks — private feedback' },
        { hash: 'co-done', label: 'Already checked out' },
        { hash: 'co-locked', label: 'Not available yet' },
      ]},
      { file: 'flow-checkout-desktop.html', label: 'Check-out — desktop', icon: '🖥', by: 'opus', subs: [
        { hash: 'cd-leave', label: 'Before you leave (balance due)' },
        { hash: 'cd-zero', label: 'Nothing to pay' },
        { hash: 'cd-rate', label: 'Rate your stay' },
        { hash: 'cd-thanks', label: 'Thanks — public reviews' },
        { hash: 'cd-thanks-quiet', label: 'Thanks — private feedback' },
        { hash: 'cd-done', label: 'Already checked out' },
        { hash: 'cd-locked', label: 'Not available yet' },
      ]},
    ]},
    { group: 'Luggage storage', items: [
